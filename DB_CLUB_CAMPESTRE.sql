...
VALUES('604420119','DAVID','MESEN',25,83)
GO
...
([RESERVA_ID],[CANT_PERSONAS],[FECHA],[NUM_HABITACION],[CED_CLIENTE],[HABITACION_RESERVADA])
VALUES(651,4,SYSDATETIME(),13,'604420119','CABA_A')
GO
...
CREATE PROCEDURE SP_INSERTAR_CLIENTES
 ...
 AS
 INSERT INTO [SCH_CLUB].[TB_RESERVAS]([RESERVA_ID],[CANT_PERSONAS],[FECHA],[NUM_HABITACION],[CED_CLIENTE],[HABITACION_RESERVADA])
 VALUES(@RESERVA_ID,@CANT_PERSONAS,SYSDATETIME(),@NUM_HABITACION,@CED_CLIENTE,@HABITACION_RESERVADA)
 GO
 ---------------------------------------------------------------
